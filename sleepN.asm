...
main(int argc, char *argv[])
{
  ...
  37:	68 81 08 00 00       	push   $0x881
  3c:	6a 01                	push   $0x1
  3e:	e8 88 04 00 00       	call   4cb <printf>
...
itoa(int val, int base){
 ...
 2b6:	0f b6 80 aa 08 00 00 	movzbl 0x8aa(%eax),%eax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 467:	0f b6 80 2c 0b 00 00 	movzbl 0xb2c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5a3:	75 25                	jne    5ca <printf+0xff>
          s = "(null)";
 5a5:	c7 45 f4 bb 08 00 00 	movl   $0x8bb,-0xc(%ebp)
        while(*s != 0){
